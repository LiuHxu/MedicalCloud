...
<html>
  ...
  <body>
  <div class="header">
  	<h1><a href="#" id="enter">云计算服务门户入口</a></h1>
  </div>
  <div class="container">
		<div class="col-md-offset-4 col-lg-offset-4col-xl-offset-4">
        	<form action="./servlet/CloudServiceEngineering" class="">
            	...
            	<select class="form-control" name="select">
              		...
              		<option value="Epidemic">防疫云</option>
            	</select>
            	<button class="btn btn-primary form-control">进入云</button>
          		</div>
          	</form>
          </div>
	</div>
